              ...
              <div className="nav-dropdown-menu">
                {internshipPrograms.map((course) => (
                  ...
                  >
                    ...
                    <span className="dropdown-label">{course.title}</span>
                  </Link>
                ))}
              </div>
            </li>
              ...
              <div className="nav-dropdown-menu">
                {careerLaunchPrograms.map((prog) => (
                  ...
                  >
                    ...
                    <span className="dropdown-label">{prog.title}</span>
                  </Link>
                ))}
              </div>
            </li>
        ...
        <ul className="mobile-nav-list">
          ...
          <li>
            ...
            >
              ...
              <i
                className={`bi bi-chevron-${mobileInternshipsOpen ? "up" : "down"} accordion-icon`}
              ></i>
            </button>
            <ul
              className={`mobile-submenu${mobileInternshipsOpen ? " open" : ""}`}
            >
              <li>
                <Link
                  to="/internships"
          ...
          <li>
            ...
            >
              ...
              <i
                className={`bi bi-chevron-${mobileCareerOpen ? "up" : "down"} accordion-icon`}
              ></i>
            </button>
